...
<span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">method</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>\u8FD9\u662F\u6570\u636E\u52AB\u6301\u7684\u90E8\u5206\uFF0C\u63A5\u4E0B\u6765\u8BF4\u4E0B\u89C6\u56FE\u66F4\u65B0\u7684\u673A\u5236\uFF1A</p><ol><li>\u7531\u4E8E Vue \u6267\u884C\u4E00\u4E2A\u7EC4\u4EF6\u7684 render \u51FD\u6570\u662F\u7531 Watcher \u53BB\u4EE3\u7406\u6267\u884C\u7684\uFF0CWatcher \u5728\u6267\u884C\u524D\u4F1A\u628A Watcher \u81EA\u8EAB\u5148\u8D4B\u503C\u7ED9 Dep.target \u8FD9\u4E2A\u5168\u5C40\u53D8\u91CF\uFF0C\u7B49\u5F85\u54CD\u5E94\u5F0F\u5C5E\u6027\u53BB\u6536\u96C6\u5B83\u3002</li><li>\u5728\u7EC4\u4EF6\u6267\u884C render \u51FD\u6570\u65F6\u8BBF\u95EE\u4E86\u54CD\u5E94\u5F0F\u5C5E\u6027\uFF0C\u54CD\u5E94\u5F0F\u5C5E\u6027\u5C31\u4F1A\u7CBE\u786E\u7684\u6536\u96C6\u5230\u5F53\u524D\u5168\u5C40\u5B58\u5728\u7684 Dep.target \u4F5C\u4E3A\u81EA\u8EAB\u7684\u4F9D\u8D56\u3002</li><li>\u5728\u54CD\u5E94\u5F0F\u5C5E\u6027\u53D1\u751F\u66F4\u65B0\u65F6\u901A\u77E5 Watcher \u53BB\u91CD\u65B0\u8C03\u7528<code>vm._update(vm._render())</code>\u8FDB\u884C\u7EC4\u4EF6\u7684\u89C6\u56FE\u66F4\u65B0\uFF0C\u89C6\u56FE\u66F4\u65B0\u7684\u65F6\u5019\u4F1A\u901A\u8FC7 diff \u7B97\u6CD5\u5BF9\u6BD4\u65B0\u8001 vnode \u5DEE\u5F02\uFF0C\u901A\u8FC7 patch \u5373\u65F6\u66F4\u65B0 DOM\u3002</li></ol><h2 id="_2-v-if-\u548C-v-for-\u54EA\u4E2A\u4F18\u5148\u7EA7\u9AD8" tabindex="-1"><a class="header-anchor" href="#_2-v-if-\u548C-v-for-\u54EA\u4E2A\u4F18\u5148\u7EA7\u9AD8" aria-hidden="true">#</a> 2.v-if \u548C v-for \u54EA\u4E2A\u4F18\u5148\u7EA7\u9AD8</h2><p>\u7B54\u6848\u662F v-for \u89E3\u6790\u7684\u4F18\u5148\u7EA7\u9AD8\uFF0C\u53EF\u4EE5\u5728\u6E90\u7801\u7684 compiler/codegen/index.js \u91CC\u7684 genElement \u51FD\u6570\u627E\u5230\u7B54\u6848</p><div class="language-javscript ext-javscript line-numbers-mode"><pre class="language-javscript"><code>function genElement (el: ASTElement, state: CodegenState): string {
  if (el.parent) {
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="_5-nexttick-\u539F\u7406" tabindex="-1"><a class="header-anchor" href="#_5-nexttick-\u539F\u7406" aria-hidden="true">#</a> 5.nextTick \u539F\u7406</h2><p>\u5148\u770B\u4E0B\u5B98\u65B9\u6587\u6863\u7684\u8BF4\u660E\uFF1A</p><blockquote><p>Vue \u5728\u66F4\u65B0 DOM \u65F6\u662F\u5F02\u6B65\u6267\u884C\u7684\u3002\u53EA\u8981\u4FA6\u542C\u5230\u6570\u636E\u53D8\u5316\uFF0CVue \u5C06\u5F00\u542F\u4E00\u4E2A\u961F\u5217\uFF0C\u5E76\u7F13\u51B2\u5728\u540C\u4E00\u4E8B\u4EF6\u5FAA\u73AF\u4E2D\u53D1\u751F\u7684\u6240\u6709\u6570\u636E\u53D8\u66F4\u3002\u5982\u679C\u540C\u4E00\u4E2A watcher \u88AB\u591A\u6B21\u89E6\u53D1\uFF0C\u53EA\u4F1A\u88AB\u63A8\u5165\u5230\u961F\u5217\u4E2D\u4E00\u6B21\u3002</p></blockquote><p>nextTick \u5C31\u662F\u5C06\u56DE\u8C03\u51FD\u6570\u653E\u5230\u961F\u5217\u91CC\u53BB\uFF0C\u4FDD\u8BC1\u5728\u5F02\u6B65\u66F4\u65B0 DOM \u7684 watcher \u540E\u9762\uFF0C\u4ECE\u800C\u83B7\u53D6\u5230\u66F4\u65B0\u540E\u7684 DOM\u3002</p><p>\u7ED3\u5408 src/core/util/next-tick \u6E90\u7801\u518D\u8FDB\u884C\u5206\u6790\u3002</p><p>\u9996\u5148\u662F\u5B9A\u4E49\u6267\u884C\u4EFB\u52A1\u961F\u5217\u65B9\u6CD5</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>function flushCallbacks () {
  pending = false
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br></div></div><h3 id="_4-beforedestroy\u3001destroyed" tabindex="-1"><a class="header-anchor" href="#_4-beforedestroy\u3001destroyed" aria-hidden="true">#</a> 4. beforeDestroy\u3001destroyed</h3><p>\u8FD9\u4E24\u4E2A\u94A9\u5B50\u662F vue \u5B9E\u4F8B\u9500\u6BC1\u7684\u94A9\u5B50\uFF0C\u5B9A\u4E49\u5728 Vue.prototype.$destroy \u4E2D\uFF1A</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>Vue.prototype.$destroy = function () {
    const vm: Component = this
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p>\u5728\u9500\u6BC1\u4E4B\u524D\u6267\u884C callHook(vm, &#39;beforeDestroy&#39;)\uFF0C\u7136\u540E\u9500\u6BC1\u7684\u65F6\u5019\u505A\u4E86\u51E0\u4EF6\u4E8B\uFF1A</p><ul><li>\u5982\u679C\u6709\u7236\u5143\u7D20\uFF0C\u5C06\u7236\u5143\u7D20\u7684$children \u4E2D\u628A\u8BE5\u7EC4\u4EF6\u5B9E\u4F8B\u79FB\u9664\u3002</li><li>\u79FB\u9664 watchers\uFF0C\u5E76\u5728\u4F9D\u8D56\u8BA2\u9605\u8005\u4E2D\u79FB\u9664\u81EA\u5DF1\u3002</li><li>\u5220\u9664\u6570\u636E\u5F15\u7528</li></ul><h3 id="_5-activated\u3001deactivated" tabindex="-1"><a class="header-anchor" href="#_5-activated\u3001deactivated" aria-hidden="true">#</a> 5. activated\u3001deactivated</h3><p>\u5269\u4E0B\u7684\u8FD8\u6709<code>activated\u3001deactivated\u3001errorCaptured</code>\u4E09\u4E2A\u94A9\u5B50\u51FD\u6570\u3002</p><p>activated\u3001deactivated \u8FD9\u4E24\u4E2A\u94A9\u5B50\u51FD\u6570\u5206\u522B\u662F\u5728 keep-alive \u7EC4\u4EF6\u6FC0\u6D3B\u548C\u505C\u7528\u4E4B\u540E\u7684\u56DE\u8C03\u3002</p><p>errorCaptured \u6355\u83B7\u5230\u5F53\u5B50\u5B59\u7EC4\u4EF6\u9519\u8BEF\u65F6\u4F1A\u88AB\u8C03\u7528\uFF0C\u5728\u6E90\u7801\u4E2D\u53EF\u4EE5\u7ECF\u5E38\u770B\u5230 try catch \u4E2D catch \u4F1A\u8C03\u7528 handleError \u51FD\u6570\uFF0ChandleError \u4F1A\u5411\u7EC4\u4EF6\u6240\u6709\u7684\u7236\u7EA7\u7EC4\u4EF6\u629B\u51FA\u5F02\u5E38\uFF0C</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>function handleError (err: Error, vm: any, info: string) {
  pushTarget()
  try {
    if (vm) {
      let cur = vm
